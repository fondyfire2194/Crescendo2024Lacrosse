...
public class ShootWhileMoving extends Command {
  ...
  private DoubleSupplier m_forwardSpeed;
  private DoubleSupplier m_strafeSpeed;

  private DoubleSupplier m_maxTranslationalSpeed;
  ...
  public ShootWhileMoving(
    ...
    addRequirements(arm, transfer, shooter, swerve);
  }
  ...
  public void execute() {
    ...
    double forwardMetersPerSecond = -m_forwardSpeed.getAsDouble() * m_maxTranslationalSpeed.getAsDouble();
    double strafeMetersPerSecond = m_strafeSpeed.getAsDouble() * m_maxTranslationalSpeed.getAsDouble();
